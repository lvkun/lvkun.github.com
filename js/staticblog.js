...
(function() {
  ...
  IndexRender = (function() {
    ...
    IndexRender.prototype.add_index_item = function(post) {
      ...
      $("<td class='post-date'>").appendTo($item_value_list).text(post.date);
      ...
      for (key in _ref) {
        ...
        $tag_href.click(function() {
          if ($(this).hasClass("selected")) {
            ...
            return location.hash = location.hash.split("@")[0] + "@" + $(this).text();
          }
        });
      }
      $("#tag-panel-list").hide();
      return $("#extend-btn").click(function() {
        ...
        if ($("#extend-img").hasClass("glyphicon-circle-arrow-down")) {
          ...
          return $("#extend-img").addClass("glyphicon-circle-arrow-up");
        } else {
          $("#extend-img").removeClass("glyphicon-circle-arrow-up");
          return $("#extend-img").addClass("glyphicon-circle-arrow-down");
        }
      });
    };

    IndexRender.prototype.update_current_tag_panel = function() {
      var $tag_all, $tag_href, tag, _i, _len, _ref, _results;
